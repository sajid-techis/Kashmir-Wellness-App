// File: src/providers/dto/availability.dto.ts
...
// --- THIS IS THE NEW CLASS TO ADD ---
// It defines the shape of a single service object.
export class ServiceDto {
    @ApiProperty({ example: 'Standard Consultation', description: 'Name of the service' })
    @IsString()
    @IsNotEmpty()
    name: string;

    @ApiProperty({ example: 800, description: 'Price of the service' })
    @IsNumber()
    @Min(0)
    price: number;
}
